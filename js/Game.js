  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //salvar o valor de player.life na variável temporária currentlife
        ...
        if (index === player.index) {
          ...
          //camar a função handleCarACollisionWithCarB()
